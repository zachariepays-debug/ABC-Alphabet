...
def ia_magique(prompt, mode="doudou"):
    ...
    if mode == "doudou":
        ...
        system = "Tu es un dictionnaire simple. Donne UNIQUEMENT la définition, sans introduction. Une seule phrase courte."
...
# --- 5. DESIGN & STYLE (TITRE CORRIGÉ ICI) ---
st.markdown("""
    <style>
    ...
    /* TITRE CORRIGÉ : VIOLET FONCÉ ET BIEN LISIBLE */
    .titre-enfant { 
        text-align: center; 
        font-family: 'Fredoka One', cursive !important; 
        color: #5E35B1 !important; /* Violet foncé */
        font-size: 45px !important; 
        text-shadow: 4px 4px 0px white, -1px -1px 0px white, 1px -1px 0px white, -1px 1px 0px white, 1px 1px 0px white; /* Gros contour blanc */
        margin-top: 10px;
        margin-bottom: 10px;
    }
    ...
    .stButton > button { 
        ...
        margin-bottom: 15px !important; white-space: normal !important;
    }
