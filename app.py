...
st.markdown("""
    ...
    .titre-enfant { 
        text-align: center; font-family: 'Fredoka One', cursive !important; color: #5E35B1 !important; 
        font-size: 45px !important; text-shadow: 4px 4px 0px white, -1px -1px 0px white, 1px -1px 0px white, -1px 1px 0px white, 1px 1px 0px white;
        margin-bottom: 10px;
    }

    .stButton > button { 
        background: white !important; border: 5px solid #5E35B1 !important; border-radius: 35px !important; 
        color: #5E35B1 !important; font-family: 'Fredoka One', cursive !important; font-size: 22px !important; 
        min-height: 90px !important; width: 100% !important; box-shadow: 0px 8px 0px #D1C4E9 !important; 
        margin-bottom: 15px !important;
    }

    .calc-screen { 
        background: white; border: 4px solid #5E35B1; border-radius: 15px; padding: 15px; 
        text-align: left; font-size: 35px; font-family: 'Fredoka One', cursive; color: #5E35B1; 
        margin-bottom: 15px; min-height: 80px; display: flex; align-items: center;
    }
...
if st.session_state.mode == "accueil":
    ...
    # ON A REMIS LE 0 ICI À LA PLACE DE BONJOUR
...
# (Les autres modes DICO, IA et JEU restent les mêmes)
